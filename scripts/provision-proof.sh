...
install_plugin_fixtures() {
    ...
    local id src
    for id in "$@"; do
        if [ "$id" = "pandoc-renderer" ] || [ "$id" = "tikz-renderer" ] || [ "$id" = "revealjs-renderer" ] || [ "$id" = "latex-renderer" ] || [ "$id" = "pandoc-html-export" ] || [ "$id" = "pandoc-pdf-export" ] || [ "$id" = "beamer-pdf-export" ] || [ "$id" = "latex-pdf-export" ] || [ "$id" = "tikz-pdf-export" ] || [ "$id" = "latexmk-pdf-export" ] || [ "$id" = "pandoc-md-lint" ] || [ "$id" = "workspace-search" ] || [ "$id" = "arxiv-export" ]; then
