...
> **Canonical source — project wiki (single source of truth):** [Failure Semantics and Product State Model](https://github.com/dzackgarza/pandoc-preview-greenfield2/wiki/Failure-Semantics-and-Product-State-Model) Edit the doctrine there; this file is a pointer for iwe recall.
