...
- [ ] **Slides editing mode**: an entirely separate renderer plugin, hot-swappable for the standard pandoc rendering plugin — ultimately just a different pandoc command with canonical output as reveal.js slides.
